...
def _render_flow(*, cluster_defaults: dict, module_name: str) -> str:
    ...
    return (
        ...
        '    # 외부 LLM endpoint 지원 — vLLM / 사내 서버 / OpenAI 호환 (XGEN_HARNESS_BASE_URL 또는\n'
        '    # 표준 OPENAI_BASE_URL / ANTHROPIC_BASE_URL env 박으면 자동 적용)\n'
        '    base_url = (\n'
        ...
        '    provider_kwargs = {"api_key": _resolve_api_key(provider_name), "model": model_override}\n'
        '    if base_url:\n'
