    ...
    "s06_context": {
        ...
        "fields": [
            ...
            },
            {
                ...
                "label": "압축 전략",
                "type": "select",
                "options": ["token_budget", "sliding_window", "microcompact", "context_collapse_overlay", "autocompact_llm"],
                "default": "token_budget",
                "description": "token_budget: 기본 파괴적 3단계 / sliding_window: 최근 N 개 / microcompact (L3): 오래된 tool_result 만 placeholder (Claude Code L3) / context_collapse_overlay (L4): 비파괴 overlay (Claude Code L4) / autocompact_llm (L5): child LLM 9-section summary (Claude Code L5)",
            },
            {
