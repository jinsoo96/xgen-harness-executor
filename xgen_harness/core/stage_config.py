    ...
    "s06_context": {
        ...
        "fields": [
            ...
            },
            {
                ...
                "label": "압축 전략",
                "type": "select",
                "options": ["token_budget", "sliding_window", "context_collapse_overlay"],
                "default": "token_budget",
                "description": "token_budget: 기본 파괴적 3단계 압축 / sliding_window: 최근 N 개만 / context_collapse_overlay: 비파괴 L4 — 중간 메시지 pd_stores['history'] 보존 + overlay 마커 (Claude Code L4)",
            },
            {
