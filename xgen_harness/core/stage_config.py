    ...
    "s06_context": {
        ...
        "fields": [
            ...
            },
            {
                ...
                "label": "압축 전략",
                "type": "select",
                "options": ["token_budget", "sliding_window", "context_collapse_overlay", "autocompact_llm"],
                "default": "token_budget",
                "description": "token_budget: 기본 파괴적 3단계 / sliding_window: 최근 N 개 / context_collapse_overlay (L4): 비파괴 overlay 마커 / autocompact_llm (L5): child LLM 이 9-section summary 생성, 원본은 pd_stores 보존 (Claude Code L5)",
            },
            {
