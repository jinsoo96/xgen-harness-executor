...
v0.11.22 — code review B+ 항목 "s06_context.py 에 5 책임 공존" 해소 1 단계.
AdvancedContextCompactor ABC 와 4 구현체를 여기에 이주. Advanced 들은 현재는
stage 헬퍼 (_try_microcompact 등) 로 위임하지만, 내부 로직을 stage 에서 떼어내
여기로 점진 이주할 수 있도록 분리 지점을 명확히 한다.
